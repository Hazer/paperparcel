...
public class ExcludeFieldsTests {
  ...
  @Test public void excludeFieldAnnotatedFieldIsIgnoredTest() throws Exception {
    JavaFileObject source =
        JavaFileObjects.forSourceString("test.Test", Joiner.on('\n').join(
            "package test;",
            "import nz.bradcampbell.paperparcel.ExcludeField;",
            "import nz.bradcampbell.paperparcel.PaperParcel;",
            "@PaperParcel",
            "public final class Test {",
            "  @ExcludeField private final int child = 0;",
            "}"
        ));
